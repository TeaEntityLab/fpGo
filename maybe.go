...
//
// NOTE: Unlike the numeric unsigned conversions (ToUint/ToByte/ToUint16/
// ToUint32/ToUint64), which reject negative signed inputs with
// ErrConversionSizeOverflow, ToUintptr intentionally reinterprets a negative
